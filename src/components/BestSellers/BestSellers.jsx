  ...
  return (
    <div>
        <section className='bestSellers'> 
            <h2 className='text-center'>Лучшие продажи</h2>
            ...
            <button className="carousel-control-prev prev__btn2" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
                <span className="left-icon"   aria-hidden="true"><i className="bi bi-chevron-left"></i></span>
                <span className="visually-hidden">Previous</span>
            </button>
            <button className="carousel-control-next next__btn2" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
